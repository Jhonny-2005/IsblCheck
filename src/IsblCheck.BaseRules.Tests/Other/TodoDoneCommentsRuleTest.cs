...
namespace IsblCheck.BaseRules.Tests.Other
{
  ...
  public class TodoDoneCommentsRuleTest
  {
    ...
    {
      var report = TestHelper.ApplyRule(rule, "// TODO: fix this later");
    ...
    {
      var report = TestHelper.ApplyRule(rule, "// DONE: implemented");
    ...
    {
      var report = TestHelper.ApplyRule(rule, "// this is a regular comment");
