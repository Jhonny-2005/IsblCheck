...
**Версия 2.8.0** — Исправление версий в GUI и очистка
...
2. Скачайте файл `IsblCheck-v2.8.0.zip` из последнего релиза
...
* Исправлены hardcoded версии в GUI: StartPageView.xaml и PanelContainerWindow.xaml теперь показывают "Версия 2.8.0"
* Обновлено количество правил в статусной строке (29 → 53)
* Удалены остатки удаленного правила B003 из Resources.resx и Resources.Designer.cs
* Удалено B003 из таблицы правил в README
* Обновлены версии в инсталляторах (2.7.0.0 → 2.8.0.0)

## Что нового в v2.7.0

* Пересобраны бинарники — теперь отображают актуальную версию (ранее показывали v2.0.0)
* Исправлены ошибки компиляции (отсутствующие using-директивы, несуществующие методы)
* Исправлена ошибка в BaseRuleFactory (остаточный using удаленной библиотеки)
* Обновлены версии в инсталляторах (2.6.0.0 → 2.7.0.0)
